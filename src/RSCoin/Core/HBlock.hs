...
mkHBlock
    ...
    -> Dpk
    -> HBlock
mkHBlock txset prevBlock newAddrs coldKeys sk dpk =
    mkHBlockDo txset newAddrs coldKeys sk dpk (hbHash prevBlock)
...
mkHBlockDo
    ...
    -> Hash
    -> HBlock
mkHBlockDo hbTransactions hbAddresses hbColdKeys sk hbDpk prevHash = HBlock {..}
  where
